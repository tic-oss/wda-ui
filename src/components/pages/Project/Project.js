...
import ReadOnlyEdgeModal from "../../modals/ReadOnlyEdgeModal";
  ...
  return (
    <>
      <div className="dndflow">
        <ReactFlowProvider>
          <div
            className="reactflow-wrapper projectPageBlock"
            ref={reactFlowWrapper}
          >
            <div>
              <button className="edit" onClick={(e) => handleEditClick()}>
                <svg
                  stroke="#6b7280"
                  fill="none"
                  strokeWidth="2"
