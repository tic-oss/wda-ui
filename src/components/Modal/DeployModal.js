...
const DeployModal = ({ isOpen, onClose, onSubmit,CurrentNode}) => {
  console.log(CurrentNode,isOpen)
    const IntialState ={
        ...
        ...(DeploymentData.deploymentType==='kubernetes' ? {'clusterName':'', 'kubernetesUseDynamicStorage':''} : {}),
        ...(DeploymentData.kubernetesUseDynamicStorage==='yes' ? { 'kubernetesStorageClassName':'', 'kubernetesNamespace':''} : {}),
        'ingress':'istio',
        'monitoring':'',
        'ingressDomain':'',
        'k8sWebUI':'',
